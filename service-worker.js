const CACHE_NAME = "opic-pwa-v11-5";
const ASSETS = ["./","./index.html","./data.js","./manifest.json","./icon-192.png","./icon-512.png","./baekho-smile.png","./baekho-rest.png","./baekho-focus.png","./baekho-listen.png","./baekho-mascot-set.png"];
